...
col2.metric(label="Filter Width", value=f"{st.session_state.fwidth} nm", delta="")
col3.metric(label="Filter Tilt", value=f"{st.session_state.tilt}°", delta="")
col4.metric(label='Hα at',value=f"{ha_at(st.session_state.gal_velocity):.1f} Å",delta="")
col5.metric(label='Field of View',value=f"{st.session_state.fov}",delta="")
