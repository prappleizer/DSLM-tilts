...
ha_tilt = st.sidebar.slider('H-alpha Filter Tilt',min_value=0.0,max_value=20.0,value=10.0,step=0.25,key='ha_tilt') 
oiii_tilt = st.sidebar.slider('[OIII] Filter Tilt',min_value=0.0,max_value=20.0,value=10.0,step=0.25,key='oiii_tilt') 
width = 0.8
